 ...
 * @author linzhichao
 */
Ext.define('lppExt.form.field.datetime.DateTimePicker', {
    ...
    renderTpl: [
        ...
        '</div>',
        {
            ...
            renderMinute: function (values, out) {
                if (Ext.isIE7m) {
                    out.push('<font style="float:left;font-weight:bold;">&nbsp;&nbsp;:&nbsp;&nbsp;</font>');
                }
                else {
                    out.push('<font style="float:left;font-weight:bold;margin: 0 4px 0 3px;">&nbsp;&nbsp;&nbsp;:</font>');
                }
            ...
            ownerLayout: me.getComponentLayout(),
           	...
           	listeners: {
                 ...
                 render: function (field, e) {
                     if (Ext.isIE7m) {
                         field.getEl().dom.style.width = '50px';
                     }
                 }
             }
        });
