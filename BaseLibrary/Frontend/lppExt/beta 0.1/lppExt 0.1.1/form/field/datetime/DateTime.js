 ...
 * @author linzhichao
 */
Ext.define('lppExt.form.field.datetime.DateTime', {
    extend:'Ext.form.field.Date',
    alias: 'widget.datetimefield',
    requires: ['lppExt.form.field.datetime.DateTimePicker'],
    ...
    createPicker: function() {
        ...
        return Ext.create('lppExt.form.field.datetime.DateTimePicker', {
            pickerField: me,
            ownerCt: me.ownerCt,
